...
@section('content_header')
    <h1>Relatório ⇨ Taxa de vitória dos jogadores  </h1>
@stop
@section('content')
        <div class="col-md-12">
            @if ($errors->has('error'))
            ...
            <div class="card">
                <div class="card-header with-border">
                    <h3 class="card-title">Relatório de taxa de vitória dos jogadores por um determinado período</h3>
                            ...
                            <div class="col-md-8">
                                <div class="form-group {{ $errors->has('data_de_atendimento') ? 'has-error' : '' }}">
                                    <label>Período em dias</label>
                                        <input type="text" class="form-control pull-right" id="data_de_atendimento" name="data_de_atendimento" value="{{ old('data_de_atendimento') }}">
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control pull-right" id="opcoes">
                                            <option value="0" selected> Customizado</option>
                    ...
                    <div class="card-footer">
                        <a  id="btnXlsx" onclick="exportarXlxs()" class="btn btn-flat btn-default float-right">Exportar XLSX &nbsp;<i class="far fa-file-excel"></i></a>
...
@section('js')
    ...
    <script>
        ...
        $("#opcoes").change(function () {
           ...
           if($(this).val() == 0){
               $("#data_de_atendimento").attr("readonly", false);
           }else {
               startdate = moment();
               if ($(this).val() == 7) {
                   $("#data_de_atendimento").attr("readonly", true);
        ...
        function exportarPdf() {
            ...
            if(val){
                ...
                window.open('/relatorio/jogadores/winrate/pdf/'+dataInicial+'/'+dataFinal, '_blank');
        ...
        function exportarXlxs() {
            ...
            if(val){
                ...
                var dataFinal = moment($.trim(split[1]), 'DD/MM/YYYY');
                dataFinal = dataFinal.format('YYYY-MM-DD');
                window.open('/relatorio/jogadores/winrate/xlsx/'+dataInicial+'/'+dataFinal, '_blank');
